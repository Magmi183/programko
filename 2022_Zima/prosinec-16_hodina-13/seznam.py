...
Hráči se budou střídat. Pozici, na kterou chtějí umístit svůj symbol budou zadávat ve formátu souřadni, tedy např.
...
# Jak změnit políčko vlevo nahoře na křížek:
# plocha[0][0] = "x"
