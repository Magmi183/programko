...
(Pozor: Na děti nemusí přesně fungovat.)

Jak se BMI počítá si najděte na internetu, i to je součástí úkolu.

BONUSOVÝ ÚKOL: Přidejte i evaluaci, tedy řekněte uživateli, do jaké kategorie spadá (podváha, normální váha, nadváha...).
"""
...
# Úlohy s nižší prioritou:

"""
Úloha A: Random příklad
