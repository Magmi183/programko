...
@app.route("/pocitadlo")
def pocitadlo():
    # použití global umožňuje funkci změnit hodnotu globální proměnné (proměnná, která je mimo funkci)
...
def bmi_calculator():
    ...
    if request.method == 'POST':
        ...
        if height and weight:
            ...
            result = round(bmi, 2)
    return render_template('bmi_form.html', height=height, weight=weight, result=result)
