...
Vaším úkolem je projít celý seznam a pozdravit každého psa i člověka, ale pozor:
 - psa pozdravte: "Ahoj pejsku"
...
seznam = ["Anička", "Fanda", "Alík", "Bimbo", "Frodo", "Gandalf", "Václav", "Hugo"]
