...
osudi_1 = {
    "Eda": [4, 5, 4, 5, 3],
    "Albert": [3, 2, 3, 2, 4, 2, 3, 4, 2],
    "Kuba": [3, 4, 5, 3, 4],
    "Aleš": [5, 4, 5, 5, 4, 2, 5, 5, 5, 5],
...
osudi_2 = {
    ...
    "Šimon": [5, 1, 1, 3, 1, 5, 1, 1, 5, 5, 4, 4, 3],
    "Štěpán": [4, 1, 5, 1, 1, 4, 2, 4, 3, 4, 2, 4],
    "Andreii": [1, 2, 4, 1, 1, 1],
    "Kuba" : [5, 4, 1, 5, 3, 4, 1, 1, 1, 5],
    "Jáchym" : [2, 1, 3, 5, 2, 1, 1, 2, 1, 3, 3, 2],
    "Ondra" : [1, 1, 1, 3, 1, 3, 2, 1, 4, 3, 3, 1, 2, 1],
}

# Pokročilí
osudi_3 = {
    "Martin": [1, 2, 3, 1, 1, 5, 2],
    "Petr": [5, 5, 5, 5, 3, 5, 5, 3, 2, 4],
    "Honza": [4, 1, 4, 4, 4, 1],
    "David": [2, 4, 2, 5, 5],
    "Oskar": [4, 2, 5, 3, 3],
    "Tonda": [3, 3, 2, 1, 1, 4, 3],
