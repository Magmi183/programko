...
osudi_1 = {
    "Eda": [4, 5, 4, 5, 3, 4, 3, 3],
    "Albert": [3, 2, 3, 2, 4, 2, 3, 4, 2, 2, 1, 3, 2, 2],
    "Kuba": [3, 4, 5, 3, 4, 1, 2, 1, 1, 1],
    "Aleš": [5, 4, 5, 5, 4, 2, 5, 5, 5, 5, 4, 6, 5, 4, 6],
    "Emilie": [2, 2, 2, 3, 3, 3, 4, 3, 1, 3, 6, 4], # zahrnuje počáteční boost
}

# Starší začátečníci
osudi_2 = {
    "Richard": [3, 3, 1, 2, 5, 2, 2, 2, 2, 4, 2, 5, 1, 5, 1, 3, 3],
    "Šimon": [5, 1, 1, 3, 1, 5, 1, 1, 5, 5, 4, 4, 3, 2, 3, 5, 2, 4],
    "Štěpán": [4, 1, 5, 1, 1, 4, 2, 4, 3, 4, 2, 4, 1, 2, 6, 1],
    "Andreii": [1, 2, 4, 1, 1, 1, 4, 1],
    "Kuba" : [5, 4, 1, 5, 3, 4, 1, 1, 1, 5, 3],
    "Jáchym" : [2, 1, 3, 5, 2, 1, 1, 2, 1, 3, 3, 2, 5, 6, 4, 6],
