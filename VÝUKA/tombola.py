...
osudi_1 = {
    ...
    "Albert": [4, 2, 2, 2, 1, 4, 2, 3, 5, 4],  # majty
    "Kuba": [3, 3, 1, 4, 3, 4, 3, 4, 1, 2, 1],
    "Ondra": [2, 2, 1, 3, 5, 1, 3, 2, 2],
    "Aleš": [1, 3, 5, 5, 1, 3, 3, 5, 4, 2, 5, 3, 5], # kuře
    "Vašek": [5, 1, 1, 3, 3],
    "Andrej": [4, 4], # drak
    "Sofia": [3, 1, 5, 1, 1]
}
...
# Starší začátečníci
osudi_2 = {
    "Richard": [5, 5, 3, 3, 3, 4, 2, 4, 5, 2, 5, 3], # paul
    "Matěj": [4, 4, 4, 4, 5, 1],
    "Šimon": [3, 3, 2, 1, 3, 5, 2, 1, 2, 4],
    "Štěpán": [2, 3, 5, 2, 5, 5, 4, 2], # lednacek
    "Andreii": [1, 1, 3, 2, 3, 4],
    "Kuba" : [2, 5, 1, 2, 3, 3, 3, 1],
...
osudi_3 = {
    ...
    "Petr": [4, 2, 4, 5, 5, 1, 5, 4, 5, 4],
    "Honza": [3, 1, 3, 3, 4, 1, 4, 5, 1, 5],
    "David": [2, 4, 4, 3, 3, 3, 1],
