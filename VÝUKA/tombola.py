...
osudi_1 = {
    ...
    "Kuba": [3, 4, 5, 3],
    "Aleš": [5, 4, 5, 5, 4, 2],
    "Emilie": [2, 2, 2, 3, 3, 1], # zahrnuje počáteční boost
}

# Starší začátečníci
osudi_2 = {
    "Richard": [3, 3, 1, 2, 5, 2, 2, 2, 2, 4],
    "Šimon": [5, 1, 1, 3, 1, 5, 1, 1, 5],
    "Štěpán": [4, 1, 5, 1, 1, 4, 2, 4, 3],
    "Andreii": [1, 2, 4, 1, 1, 1],
    "Kuba" : [5, 4, 1, 5, 3, 4, 1, 1, 1, 5],
    "Jáchym" : [2, 1, 3, 5, 2, 1, 1, 2],
    "Ondra" : [1, 1, 1, 3, 1, 3, 2, 1, 4, 3],
}
