...
osudi_1 = {
    "Eda": [5, 1, 4, 4, 2, 2],
    "Albert": [4, 2, 2, 2, 1, 4, 2],  # majty
    "Kuba": [3, 3, 1, 4, 3, 4, 3],
    "Ondra": [2, 2, 1, 3, 5, 1],
    "Aleš": [1, 3, 5, 5, 1, 3, 3, 5, 4], # kuře
    "Vašek": [5, 1, 1, 3],
    "Andrej": [4, 4], # drak
    "Sonia": [3, 1, 5, 1]
}
...
# Starší začátečníci
osudi_2 = {
    "Richard": [5, 5, 3, 3, 3, 4, 2, 4, 5], # paul
    "Matěj": [4, 4, 4, 4, 5, 1],
    "Šimon": [3, 3, 2, 1, 3, 5, 2, 1],
    "Štěpán": [2, 3, 5, 2, 5, 5], # lednacek
    "Andreii": [1, 1, 3, 2],
    "Kuba" : [2, 5, 1, 2, 3],
    "Jáchym" : [4, 1, 2, 4, 4, 4], # naruto
    "Ondra" : [3, 1, 1, 3]
}
