...
osudi_1 = {
    "Eda": [5, 1, 4, 4, 2, 2, 5, 4],
    "Albert": [4, 2, 2, 2, 1, 4, 2, 3],  # majty
    "Kuba": [3, 3, 1, 4, 3, 4, 3, 4, 1],
    "Ondra": [2, 2, 1, 3, 5, 1, 3, 2],
    "Aleš": [1, 3, 5, 5, 1, 3, 3, 5, 4, 2, 5], # kuře
    "Vašek": [5, 1, 1, 3],
    "Andrej": [4, 4], # drak
    "Sofia": [3, 1, 5, 1, 1]
}
...
# Pokročilí
osudi_3 = {
    "Martin": [5, 5, 1, 3, 5, 4, 2],
    "Petr": [4, 2, 4, 5, 5, 1, 5, 4],
    "Honza": [3, 1, 3, 3, 4, 1, 4, 5],
    "David": [2, 4, 4, 3, 3],
