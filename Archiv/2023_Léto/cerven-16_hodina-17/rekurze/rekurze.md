...
Co je to rekurze? (kromě toho, že je to jistá forma mentální gymnastiky...)

Co se stane, když vytvoříte funkci a **uvnitř té funkce použijete tu samou funkci**? Skončí ta funkce někdy, když ji pak zavoláte?
No, to záleží, jak tu funkci uděláte.

A přesně tohle je základ rekurze - uděláte funkci a už v té funkci samotné ji použijete. Je to užitečná technika, když
máte nějaký úkol, který obsahuje nebo se dá rozdělit na více úkolů stejného typu.

S rekurzí se můžeme setkat i v životě. Vemte si například _matriošku_, ta obsahuje další matriošku, a ta další, a tak dále,
než to dorazí na nejmenší matriošku, která už se nedá rozdělit. Můžete se na to koukat jako na funkci, která volá sama sebe. 
Matrioško, co máš uvnitř? Matrioušku. Matrioško, co máš uvnitř? Matrioušku. Matrioško, co máš uvnitř? Matrioušku. ... Matrioško, co máš uvnitř? Poslední panenku, která už se nedá rozložit. 
Napadají vás další příklady, kde na rekurzi v reálném životě narazit?

<p align="center">
  <img src="matrioska.jpg" alt="Matrioska panenky">
</p>
...
Všimni si, že každá rekurzivní funkce musí mít nějakou podmínku, která když je splněna, tak rekurze skončí. Pokud na zastavovací podmínku zapomeneš nebo ji zvolíš špatně, pak se funkce může volat donekonečna. Přesněji řečeno, dokud program nespadne.


# Credits

Tento text jsem převzal z: https://github.com/pyvec/naucse-python/blob/main/lessons/beginners/recursion/index.md
Text jsem upravil tak, aby lépe vyhovoval pro účely mého konkrétního kroužku pro děti.
Tímto děkuji autorovi Petru Viktorinovi!